...
tests = [ {'description': 'Do nothing',
    ...
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 5},
        ...
        {'inputs': [('PINA', 0x00)],'iterations': 5, 'expected': [('PORTC', 0x09)]},
    ...
    'steps': [ {'inputs': [('PINA', 0x02)],'iterations': 5},
        {'inputs': [('PINA', 0x02)],'iterations': 5, 'expected': [('PORTC', 0x08)]},  
        {'inputs': [('PINA', 0x00)],'iterations': 5, 'expected': [('PORTC', 0x08)]},
    ...
    'steps': [ {'inputs': [('PINA',0x03)], 'time': 300, 'iterations': 3 } ],
    'expected': [('PORTC', 0x00)],
    },
    {'description': 'Decrement at zero',
