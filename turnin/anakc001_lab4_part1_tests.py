...
tests = [ {'description': 'PIN A not pressed.',
    'steps': [ {'inputs': [('PINA',0x00)], 'time': 300, 'iterations': 1 } ],
    'expected': [('PORTB', 0x01)],
    },
    {'description': 'Pin A press and release.',
    ...
    {'description': 'Pin A press and release and press again.',
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 5}, # reset from previous test
    ...
    {'description': 'Go entire cycle',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 5}, # reset from previous test
